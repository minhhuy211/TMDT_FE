      ...
      <footer className="bg-white border-t py-8">
        <div className="container mx-16 px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="mb-4">
                <img src={logo} alt="Triple D Logo" width={100} height={40} />
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>
                  <Link to="#">Máy in 3D</Link>
                </li>
                <li>
                  <Link to="#">Vật liệu in</Link>
                </li>
                <li>
                  <Link to="#">Phụ kiện</Link>
                </li>
                <li>
                  <Link to="#">Dịch vụ in 3D</Link>
                </li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t mt-8 pt-6 text-center text-sm text-gray-600">
            <p>&copy; {new Date().getFullYear()} Triple D. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
