...
import { Product, ProductResponse } from "@/model/Product.ts";
import ProductCard from "@/pages/Products/ProductCard.tsx";
import { Link } from "react-router-dom";
import productApi from "@/services/productApi";
import TopNewProductCard from "../Products/TopNewProductCard";
...
export const HomePage = () => {
  ...
  const { data: categories = [], isLoading: loadingCate } = useQuery<
    Category[]
  >({
    queryKey: ["categories"],
  ...
  useEffect(() => {
    const fetchNewProduct = async () => {
      try {
        const data = await productApi.getNewProducts(6);
        setLatestProducts(data);
      } catch (error) {
        console.error("Không load được sản phẩm...", error);
      }
    };
    fetchNewProduct();
  }, []);
  ...
  return (
    <main className="flex-1 ">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <Link to="/productCustom">
                <Button className="rounded-full px-6 bg-black hover:bg-gray-800">
                  Thiết kế
                </Button>
              </Link>
              <Link to="/product">
      ...
      <section className="py-0">
        <div className="mx-16 px-4">
          ...
          <p className="text-gray-600 mb-8 max-w-3xl">
            Khởi nguồn sáng tạo bắt đầu từ một thành phẩm thực và công nghệ in
            3D tiên tiến - Đủ chính xác, chất lượng vượt trội, đáp ứng mọi nhu
            cầu thiết kế của bạn!
          </p>
          <div className="flex overflow-x-auto gap-4 pb-4 mb-6 -mx-4 px-4 md:mx-0 md:px-0 no-scrollbar">
            ...
            {categories.map((cate) => (
              <Button
                key={cate.cate_ID}
                variant={
                  selectedCateId === cate.cate_ID ? "default" : "outline"
                }
                className="rounded-full whitespace-nowrap"
      ...
      <section className="py-16 bg-gray-50 rounded-lg mx-4 md:mx-8">
        <div className="mx-16 px-4">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Từ thiết kế đến giao hàng - Chúng tôi đảm bảo khách hàng tận hưởng
            sự đơn giản và thành công
          </p>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">
                Tải mô hình thiết kế của bạn lên hoặc sử dụng các mẫu có sẵn từ
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">
                Lựa chọn vật liệu, màu sắc, độ phân giải và các tùy chọn khác
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-gray-600">
                Chúng tôi sẽ in và giao sản phẩm đến tận nơi cho bạn với thời
                gian nhanh chóng
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Chúng tôi cam kết mang đến cho bạn các sản phẩm in 3D chất lượng
                cao với đầy đủ tính năng vượt trội
              </p>
              ...
              <Button className="mt-8 rounded-full px-6 bg-black hover:bg-gray-800">
                Xem thêm về dịch vụ
              </Button>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="mx-16 px-4">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-4">
            Các khách hàng nói gì?
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Dưới đây là một số đánh giá từ khách hàng đã trải nghiệm dịch vụ của
            chúng tôi. Chúng tôi luôn nỗ lực để đáp ứng và vượt quá mong đợi của
            khách hàng.
          </p>
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="border-0 shadow-md">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-gray-600">
                  "Chất lượng in ấn tuyệt vời, chi tiết sắc nét và dịch vụ khách
                  hàng rất tận tâm. Tôi rất hài lòng với sản phẩm nhận được."
                </p>
            ...
            <Card className="border-0 shadow-md">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-gray-600">
                  "Thời gian giao hàng nhanh hơn dự kiến và chất lượng sản phẩm
                  vượt quá mong đợi của tôi. Chắc chắn sẽ quay lại."
                </p>
                <div className="pt-4 border-t">
            ...
            <Card className="border-0 shadow-md">
              <CardContent className="p-6 space-y-4">
                ...
                <p className="text-gray-600">
                  "Đội ngũ hỗ trợ rất chuyên nghiệp và nhiệt tình. Họ đã giúp
                  tôi điều chỉnh thiết kế để có kết quả tốt nhất."
                </p>
                <div className="pt-4 border-t">
